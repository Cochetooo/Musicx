...
public sealed class FindAlbumByGenreService(
    HttpClient httpClient,
    ILoggerFactory loggerProvider) : IFindAlbumByGenreService
{
    private readonly ILogger _logger = loggerProvider.CreateLogger(nameof(FindAlbumByGenreService));
