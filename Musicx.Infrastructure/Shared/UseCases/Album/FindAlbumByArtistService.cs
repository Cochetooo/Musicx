...
public sealed class FindAlbumByArtistService(
    HttpClient httpClient,
    ILoggerFactory loggerProvider) : IFindAlbumByArtistService
{
    private readonly ILogger _logger = loggerProvider.CreateLogger(nameof(FindAlbumByArtistService));
