...
public static class ArtistMapper
{
    public static OutArtist FromDicoToArtist(this IDictionary<string, object?> artist) => new()
    {
        ...
        CalculatedGenreCounts = artist.SafeGet<string?>(ArtistColumns.CalculatedGenreCounts),
        CalculatedInfluenceCounts = artist.SafeGet<string?>(ArtistColumns.CalculatedInfluenceCounts),
        CalculatedDescriptorCounts = artist.SafeGet<string?>(ArtistColumns.CalculatedDescriptorCounts),
        CalculatedSceneCounts = artist.SafeGet<string?>(ArtistColumns.CalculatedSceneCounts),
        CalculatedMovementCounts = artist.SafeGet<string?>(ArtistColumns.CalculatedMovementCounts),
