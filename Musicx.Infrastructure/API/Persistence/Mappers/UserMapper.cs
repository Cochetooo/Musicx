...
public static class UserMapper
{
    ...
    public static OutUser FromDicoToUser(this IDictionary<string, object?> user) => new()
    {
        ...
        OriginCountry = user.SafeGet<string?>(UserColumns.OriginCountry),
        PrefAutoComputeAdvancedRatings = user.SafeGet<bool>(UserColumns.PrefAutoComputeAdvancedRatings),
        PrefAutoFollow = user.SafeGet<bool>(UserColumns.PrefAutoFollow),
        PrefBannerBlur = user.SafeGet<bool>(UserColumns.PrefBannerBlur),
        PrefDarkMode = user.SafeGet<bool>(UserColumns.PrefDarkMode),
        PrefHighGraphics = user.SafeGet<bool>(UserColumns.PrefHighGraphics),
        PrefLanguage = user.SafeGet<string>(UserColumns.PrefLanguage) ?? "en",
    ...
    public static InUser ToRaw(this OutUser user) => new()
    {
        ...
        PrefAutoComputeAdvancedRatings = user.PrefAutoComputeAdvancedRatings,
        PrefAutoFollow = user.PrefAutoFollow,
        PrefBannerBlur = user.PrefBannerBlur,
        PrefDarkMode = user.PrefDarkMode,
        PrefHighGraphics = user.PrefHighGraphics,
