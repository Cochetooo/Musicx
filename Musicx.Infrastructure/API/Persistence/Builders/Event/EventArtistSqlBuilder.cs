...
internal sealed class EventArtistSqlBuilder(ILoggerProvider loggerProvider) : SqlBuilder<InEventArtist>
{
    ...
    internal override string BuildSelect(IJoinSpecification<InEventArtist>? querySpecification = null, bool distinct = false)
        => distinct
    ...
    internal override string BuildGroupBy(IJoinSpecification<InEventArtist>? querySpecification = null)
        => string.Empty;
}