...
internal sealed class GenreAliasSqlBuilder(ILoggerProvider loggerProvider) : SqlBuilder<InGenreAlias>
{
    ...
    internal override string BuildSelect(IJoinSpecification<InGenreAlias>? querySpecification = null,
        bool distinct = false)
        => distinct
    ...
    internal override string BuildGroupBy(IJoinSpecification<InGenreAlias>? spec = null)
