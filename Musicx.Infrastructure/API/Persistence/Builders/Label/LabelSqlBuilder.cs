...
using Musicx.Infrastructure.API.Persistence.Specifications.Label;
using Musicx.Infrastructure.Shared.Helpers;
using Npgsql;

namespace Musicx.Infrastructure.API.Persistence.Builders.Label;
...
internal sealed class LabelSqlBuilder(ILoggerProvider loggerProvider) : SqlBuilder<InLabel>
{
    ...
    internal override string BuildSelect(IJoinSpecification<InLabel>? querySpecification = null,
        bool distinct = false)
    {
        if (querySpecification is not LabelJoinSpecification labelQuerySpecification)
        {
            return distinct
    ...
    internal override string BuildGroupBy(IJoinSpecification<InLabel>? spec = null)
