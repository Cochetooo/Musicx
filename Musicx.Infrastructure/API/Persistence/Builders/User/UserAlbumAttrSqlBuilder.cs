    ...
    internal override async Task<object?> ExecuteInsert(InUserAlbumAttribute entity, NpgsqlConnection connection, NpgsqlTransaction? transaction = null)
    {
        var createCommandSql = InsertBuilder.Build("user_album_attrs",
            new Dictionary<string, object?>
            {
                ...
                { UserAlbumAttrColumns.AtmosphereRating, entity.AtmosphereRating },
                { UserAlbumAttrColumns.InstrumentationRating, entity.InstrumentationRating },
                { UserAlbumAttrColumns.LyricsRating, entity.LyricsRating },
                { UserAlbumAttrColumns.OriginalityRating, entity.OriginalityRating },
