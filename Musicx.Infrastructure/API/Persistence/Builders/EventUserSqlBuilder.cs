...
internal sealed class EventUserSqlBuilder(ILoggerProvider loggerProvider) : SqlBuilder<InEventUser>
{
    ...
    internal override string BuildSelect(IQuerySpecification<InEventUser>? querySpecification = null, bool distinct = false)
        => distinct
    ...
    internal override string BuildGroupBy(IQuerySpecification<InEventUser>? querySpecification = null)
        => string.Empty;
}