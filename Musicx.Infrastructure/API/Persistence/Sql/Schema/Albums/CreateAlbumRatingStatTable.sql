...
create table public.album_rating_stats (
    ...
    album_rating_stats_count                bigint not null default 0,
    album_rating_stats_sum                  bigint not null default 0,
    album_rating_stats_sum_sq               bigint not null default 0,
    
    album_rating_stats_avg                  numeric(7,2) not null default 0,
    
    album_rating_stats_min                  smallint,
    album_rating_stats_max                  smallint
);