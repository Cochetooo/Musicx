...
create table public.user_album_attrs (
    ...
    user_album_attrs_production_rating           smallint check (user_album_attrs_production_rating between 0 and 10000),
    user_album_attrs_lyrics_rating               smallint check (user_album_attrs_lyrics_rating between 0 and 10000),
    user_album_attrs_instrumentation_rating      smallint check (user_album_attrs_instrumentation_rating between 0 and 10000),
    user_album_attrs_vocals_rating               smallint check (user_album_attrs_vocals_rating between 0 and 10000),
    user_album_attrs_atmosphere_rating           smallint check (user_album_attrs_atmosphere_rating between 0 and 10000),
    user_album_attrs_originality_rating          smallint check (user_album_attrs_originality_rating between 0 and 10000),
