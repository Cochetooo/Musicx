...
public sealed class GetAlbumAttrByAlbumUserService(
    HttpClient httpClient,
    ILoggerFactory loggerFactory) : IGetAlbumAttributeByAlbumUserService
{
    private readonly ILogger _logger = loggerFactory.CreateLogger<GetAlbumAttrByAlbumUserService>();
