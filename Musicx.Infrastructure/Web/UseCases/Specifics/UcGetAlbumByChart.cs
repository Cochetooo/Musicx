...
public sealed class UcGetAlbumByChart(
    HttpClient httpClient,
    ILoggerFactory loggerFactory) : IGetAlbumByChartUseCase
{
    private readonly ILogger _logger = loggerFactory.CreateLogger(nameof(UcGetAlbumByChart));
