...
public sealed class GetAlbumAttrByAlbumService(
    HttpClient httpClient,
    ILoggerFactory loggerFactory) : IGetAlbumAttributesByAlbumService
{
    private readonly ILogger _logger = loggerFactory.CreateLogger<GetAlbumAttrByAlbumService>();
