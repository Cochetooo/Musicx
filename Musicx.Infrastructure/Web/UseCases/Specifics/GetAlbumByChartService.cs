...
public sealed class GetAlbumByChartService(
    HttpClient httpClient,
    ILoggerFactory loggerFactory) : IGetAlbumByChartService
{
    private readonly ILogger _logger = loggerFactory.CreateLogger(nameof(GetAlbumByChartService));
