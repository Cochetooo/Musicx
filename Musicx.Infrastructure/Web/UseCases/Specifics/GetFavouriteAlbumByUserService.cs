...
public sealed class GetFavouriteAlbumByUserService(
    HttpClient httpClient,
    ILoggerFactory loggerFactory) : IGetFavouriteAlbumByUserService
{
    private readonly ILogger _logger = loggerFactory.CreateLogger<GetFavouriteAlbumByUserService>();
