...
public sealed class UcGetAlbumAttrByAlbumUser(
    HttpClient httpClient,
    ILoggerFactory loggerFactory) : IGetAlbumAttributeByAlbumUser
{
    private readonly ILogger _logger = loggerFactory.CreateLogger<UcGetAlbumAttrByAlbumUser>();
