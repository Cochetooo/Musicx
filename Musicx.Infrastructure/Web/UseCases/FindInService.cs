...
public sealed class FindInService<TIn, TOut>(
    HttpClient httpClient,
    ILoggerFactory loggerProvider
    ) : IFindInService<TIn, TOut> 
    where TIn : BaseInputModel
    where TOut : BaseOutputModel
{
    private readonly ILogger _logger = loggerProvider.CreateLogger(nameof(FindInService<TIn, TOut>));
