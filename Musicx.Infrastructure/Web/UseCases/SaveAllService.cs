...
public sealed class SaveAllService<T>(
    HttpClient httpClient,
    ILoggerFactory loggerFactory
    ) : ISaveAllService<T> where T : BaseInputModel
{
    private readonly ILogger _logger = loggerFactory.CreateLogger(nameof(SaveAllService<T>));
