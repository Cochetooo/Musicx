package fr.xahla.musicx.domain.service.library.data;
...
public class LocalSong {
    ...
    private LocalSong setAlbumYear() {
        try {
            ...
            this.logger.info("ALBUM_YEAR is not formatted correctly.");
        } catch (NumberFormatException exception) {
            this.logger.info("ALBUM_YEAR is not a valid number.");
        }
    ...
    private LocalSong setDiscNumber() {
        try {
            ...
            this.logger.info("DISC_NO is not a valid number.");
        }
    ...
    private LocalSong setDiscTotal() {
        try {
            ...
            if (this.discNumber > discTotal) {
                this.logger.config("DISC_TOTAL is less than DISC_NO, is it an error?");
            }
        } catch (KeyNotFoundException exception) {
            this.notFound("DISC_NO");
        } catch (NumberFormatException exception) {
    ...
    private LocalSong setMovementNumber() {
        try {
            ...
            this.logger.info("MOVEMENT_NO is not a valid number.");
        }
    ...
    private LocalSong setMovementTotal() {
        try {
            ...
            if (this.movementNumber > movementTotal) {
                this.logger.config("MOVEMENT_TOTAL is less than MOVEMENT_NO, is it an error?");
            }
        } catch (KeyNotFoundException exception) {
            this.notFound("MOVEMENT_NO");
        } catch (NumberFormatException exception) {
    ...
    private LocalSong setPartNumber() {
        try {
            ...
            this.logger.info("PART_NUMBER is not a valid number.");
        }
    ...
    private LocalSong setRating() {
        try {
            ...
            this.logger.info("RATING is not a valid number.");
        }
    ...
    private LocalSong setTrackNumber() {
        try {
            ...
            this.logger.info("TRACK is not a valid number.");
        }
    ...
    private LocalSong setTrackTotal() {
        try {
            ...
            this.logger.info("TRACK_TOTAL is not a valid number.");
        }
    ...
    private LocalSong setYear() {
        try {
            ...
            this.logger.info("YEAR is not formatted correctly.");
        } catch (NumberFormatException exception) {
            this.logger.info("YEAR is not a valid number.");
        }
